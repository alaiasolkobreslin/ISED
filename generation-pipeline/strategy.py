...
class SudokuProblemStrategy(Strategy):
    ...
    def __init__(self, unstructured_dataset):
        self.unstructured_dataset = unstructured_dataset
        self.n_rows = 9
        self.n_cols = 9
    ...
    def quizzes_and_solutions(self):
        ...
        sudoku_path = os.path.join(dir_path, 'data/Sudoku/sudoku.csv')
...
class SudokuRandomStrategy(Strategy):
    ...
    def __init__(self, unstructured_dataset):
        self.problem_strategy = SudokuProblemStrategy(unstructured_dataset)
        self.unstructured_dataset = unstructured_dataset
        self.n_rows = 9
        self.n_cols = 9
