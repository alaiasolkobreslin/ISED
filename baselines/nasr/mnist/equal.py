...
if __name__ == "__main__":
  ...
  model_dir = os.path.abspath(os.path.join(os.path.abspath(__file__), "../../model/mnist_eq"))
  ...
  results_dict['task name'] = 'equal'
  results_dict['random seed'] = args.seed
  
  dir_path = os.path.dirname(os.path.realpath(__file__))
  results_file =  dir_path + '/experiments10/equal.csv'
